...
extends GuiScreen {
    ...
    public void drawScreen(int x2, int y2, float z2) {
        ...
        this.drawCenteredString(this.mc.fontRendererObj, this.thread == null ? (Object)((Object)TextFormatting.GRAY) + "Idle..." : this.thread.getStatus(), width / 2, 29, -1);
