    ...
    public void render() {
        ...
        for (Particle particle : particleList) {
            ...
            if (mouse) {
                ...
                float distance = (float) Cupert.util.MathUtil.distance(particle.getX(), particle.getY(), Mouse.getX(), Display.getHeight() - Mouse.getY());
                ...
                for (Particle particle1 : particleList) {
                    ...
                    if (distance <= dist
                            ...
                            && (Cupert.util.MathUtil.distance(Mouse.getX(), Display.getHeight() - Mouse.getY(), particle.getX(), particle.getY()) <= dist

                            || Cupert.util.MathUtil.distance(Mouse.getX(), Display.getHeight() - Mouse.getY(), particle1.getX(), particle1.getY()) <= dist)
